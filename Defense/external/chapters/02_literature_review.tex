...
\begin{table}[H]
  ...
  \begin{tabular}{@{}p{3.8cm} p{4.7cm} p{4.7cm}@{}}
    \toprule
    \textbf{Aspect} & \textbf{Prior work} & \textbf{This thesis} \\
    \midrule
...
human figures in disaster and search-and-rescue scenes. Those four contrasts
are the compact statement of what the thesis adds, and they set up the
methodology developed in the next chapter, which turns the standpoint stated
here into a concrete detector with a fixed training and evaluation protocol.
