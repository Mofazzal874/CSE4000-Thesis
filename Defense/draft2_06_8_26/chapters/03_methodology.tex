...
architecture, the novelties and their rationale, the loss design, the extended
training methods of the second phase of the work, and the inference-time
enhancement procedures evaluated in Chapter~IV.
...
train stably and stay active, so the branch fails for a substantive reason
rather than a mechanical one: whatever it contributes, the CBAM and P2 features
already carry.
