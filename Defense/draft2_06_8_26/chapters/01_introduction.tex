...
a finished predecessor. After the defense, an extension phase ran the split
audit, the assignment experiments, the collection and annotation of the real
footage, and the adaptation study, on shared laboratory machines with
checkpoint-resumable training so that power cuts and competing users did not
lose work. The thesis is the work of a single author, so no task-assignment
matrix across members applies. Figure~\ref{fig:gantt} shows the timeline of
the two terms.
