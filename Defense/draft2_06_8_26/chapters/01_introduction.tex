...
attribution. The attention change is a substitution rather than the bolt-on
that is usual in the small-object literature: it removes the baseline's
C2PSA blocks, so the improvement arrives at a negative parameter cost. And a
negative result is treated as a first-class finding here, documented with
