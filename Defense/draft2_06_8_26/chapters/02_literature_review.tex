...
targets almost arbitrarily. Wang et al.~\cite{wang2021nwd} replaced the IoU
...
\begin{figure}[tbp]
  \centering
  \figorplaceholder{figures/figures_png_format/p2head.png}{6.5cm}
...
\begin{figure}[tbp]
  \centering
  \figorplaceholder{figures/figures_png_format/c3k2mamba.png}{6.5cm}
