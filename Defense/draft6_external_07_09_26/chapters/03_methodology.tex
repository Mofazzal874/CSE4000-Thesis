...
\begin{tabular}{|c|l|l|l|}
  \hline
  \bfseries\boldmath Layers & \bfseries\boldmath Module (arguments) & \bfseries\boldmath Output & \bfseries\boldmath Role \\
  \hline
...
\begin{figure}[tbp]
  ...
  \caption{Cell coverage of one target at four detection strides.}
...
\begin{table}[tbp]
  ...
  \begin{tabular}{|l|l|l|l|}
    \hline
    \bfseries\boldmath Configuration & \bfseries\boldmath Backbone attention & \bfseries\boldmath Detection scales & \bfseries\boldmath Neck \\
    \hline
...
\begin{figure}[tbp]
  ...
  \caption{Slicing-aided hyper inference on overlapping tiles.}
  \label{fig:sahipipe}
\end{figure}
...
\begin{figure}[tbp]
  ...
  \caption{Test-time augmentation on rescaled and flipped copies.}
  \label{fig:ttapipe}
\end{figure}
