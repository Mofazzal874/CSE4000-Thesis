...
fused scales. The insets around the figure show the model's real input,
attention map, P2 feature response, and detections on the scene. In the
table, channel counts are the values realised at the YOLO11m scale (width
1.0, channel cap 512, depth 0.5), and the rows in bold are the elements
added or modified in this work.
