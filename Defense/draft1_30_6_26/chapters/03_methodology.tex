...
\begin{figure}[tbp]
  \centering
  \figorplaceholder{figures/figures_png_format/cbam_effect.png}{5.4cm}
...
\begin{figure}[tbp]
  \centering
  \figorplaceholder{figures/figures_png_format/stride_problem.png}{6cm}
...
\begin{figure}[tbp]
  \centering
  \figorplaceholder{figures/figures_png_format/sahi.png}{8.8cm}
...
\begin{figure}[tbp]
  \centering
  \figorplaceholder{figures/figures_png_format/tta.png}{7cm}
