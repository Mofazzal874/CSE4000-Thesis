...
\begin{figure}[tbp]
  ...
  \caption{Slicing-aided hyper inference: overlapping tiles and a full-image
  pass, detected separately and merged.}
  \label{fig:sahipipe}
\end{figure}
...
\begin{figure}[tbp]
  ...
  \caption{Test-time augmentation: rescaled and flipped copies of the full
  frame, merged by non-maximum suppression.}
  \label{fig:ttapipe}
\end{figure}
