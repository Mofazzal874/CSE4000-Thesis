...
targets almost arbitrarily. Wang et al.~\cite{wang2021nwd, xu2022nwdrka} replaced the IoU
...
\begin{figure}[tbp]
  \centering
  \figorplaceholder{figures/figures_png_format/fig_ablation_chain.png}{6cm}
