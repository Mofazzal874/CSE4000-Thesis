...
in place of C2PSA, a high-resolution P2 detection scale
...
envelope without retraining. The extended methods of the second phase change
training rather than architecture: a Wasserstein blend inside the label
assigner, a rejected frequency-gated branch, and a data-mixing fine-tune for
real footage. The next chapter reports the experimental setup and the
quantitative and qualitative results of this design.
