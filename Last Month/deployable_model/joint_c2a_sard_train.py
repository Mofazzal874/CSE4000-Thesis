...
EXPLICIT_C2A_BEST_PT = None     # set a full best.pt path str to override auto-discovery
...
PATIENCE    = 50
IMG_SIZE    = 640
BATCH_SIZE  = 8                 # CBAM+P2 (stride-4 head) is VRAM-heavy at 640
NOMINAL_BATCH = 16
OPTIMIZER   = "AdamW"
LR0         = 0.001
LRF         = 0.01
...
CACHE       = "ram"
SEED        = 0
OOM_RETRY_BATCHES = [BATCH_SIZE, 4, 2]

# Eval thresholds -- IDENTICAL to the chain (spec Sec 5)
CONF_AP, IOU_AP = 0.001, 0.7
CONF_OP, IOU_OP = 0.25, 0.5

SMOKE_TEST  = True              # True -> 2-epoch tiny joint train + quick eval, then exit
SMOKE_FRACTION = 0.02
...
# =============================================================================
import os, sys, json, time, gc, shutil, math, traceback
