...
[Results](#results) | [Video demos](public-showcase/demos/README.md) | [Detection examples](public-showcase/docs/GALLERY.md) | [Evaluation notes](public-showcase/docs/EVIDENCE.md)
...
![Detector architecture and training assignment](public-showcase/assets/method.svg)
...
CBAM replaces an existing attention component, so the parameter count decreases. Mamba adds computation without improving AP50 over CBAM + P2. [Full ablation table](public-showcase/results/tab_4_4_additive_ablation.csv).
...
Overall AP50 and F2 did not consistently improve. Recall decreased in larger size groups. [Seed results](public-showcase/results/tab_4_11b_three_seed_replication.csv) | [Matched comparison](public-showcase/results/tab_4_11_matched_pair_bootstrap.csv).
...
The drone improvement is substantial. The unseen-event change is not statistically significant (paired bootstrap p = 0.468). These results support adaptation to the collected domains, not reliable transfer to arbitrary disasters. [Adaptation table](public-showcase/results/tab_4_13b_adaptation_stages.csv) | [All held-out results](public-showcase/results/tab_4_13_final_model_all_heldout_sets.csv).

![Recall changes across seeds and AP50 before and after adaptation](public-showcase/assets/results-overview.png)

## Demos

[![Annotated drone footage at 50 m](public-showcase/demos/drone-50m.jpg)](public-showcase/demos/drone-50m.mp4)

[10 m: plain inference](public-showcase/demos/drone-10m.mp4) | [50 m: tiled inference with test-time augmentation](public-showcase/demos/drone-50m.mp4)

These clips use the earlier CBAM + P2 model at confidence 0.40, not the final fine-tuned model. Boxes are predictions. The clips illustrate detections and misses; playback speed is not inference speed. [Settings](public-showcase/demos/README.md) | [Successes and failures](public-showcase/docs/GALLERY.md).
...
[Evaluation and threshold notes](public-showcase/docs/EVIDENCE.md) | [Data and method credits](public-showcase/docs/AVAILABILITY.md)
